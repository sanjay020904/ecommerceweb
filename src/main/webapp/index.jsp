...
<body>
    ...
    <header class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="${pageContext.request.contextPath}/register.jsp" class="btn btn-primary" style="padding: 8px 18px;">Register</a></li>
        </ul>
    </header>
    ...
    <main class="hero-section">
        ...
        <div style="display: flex; gap: 15px; justify-content: center;">
            <a href="${pageContext.request.contextPath}/products" class="btn btn-primary" style="padding: 14px 30px; font-size: 16px;">Shop Collection</a>
            <a href="${pageContext.request.contextPath}/register.jsp" class="btn btn-secondary" style="padding: 14px 30px; font-size: 16px;">Get Started</a>
        </div>
    </main>
